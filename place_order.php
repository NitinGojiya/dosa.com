...
<body>
  <section class="pay">
    ...
    ?>
    <div class="modal">
      <form class="form" action="place_order.php" method="post">
        ...
        <div class="credit-card-info--form">
          ...
          <div class="input_container">
            ...
            <input id="password_field" class="input_field" type="number" name="input-name" title="Inpit title" placeholder="0000 0000 0000 0000" required>
          </div>
          <div class="input_container">
            <label for="password_field" class="input_label">Expiry Date / CVV</label>
            <div class="split">
              <input id="password_field" class="input_field" type="text" name="input-name" title="Expiry Date" placeholder="01/23" required>
              <input id="password_field" class="input_field" type="number" name="cvv" title="CVV" placeholder="CVV" required>
            </div>
          </div>
        </div>
        <h3>Your Bill:-<?php echo $total; ?></h3>
        <button class="purchase--btn" name="place">Checkout</button>
      </form>
    </div>
  </section>
</body>
...
if (isset($_POST['place'])) {
  $status = "Paid";
  $action = "Not Accept";
  $sql = "SELECT * FROM `final_order` ORDER BY `final_order`.`id` ASC ";
  ...
  $sql2 = "INSERT INTO `final_order`(`id`, `name`, `total`, `username`, `status`, `mobile`, `address`,`ostatus`) VALUES ('$oid','$name','$total','$user','$status','$mobile','$address','$action')";
