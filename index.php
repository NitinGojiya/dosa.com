...
.img{
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="10000">
      <img src="slider/dosa.jpeg" height="500px" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item" data-bs-interval="2000">
      <img src="slider/Plain Dosa.jpeg" height="500px" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="slider/dosa2.jpeg" height="500px" class="d-block w-100" alt="...">
    </div>
  </div>
  <button style="background-color: #ffffff73;" class="carousel-control-prev" type="button" data-bs-target="#carouselExampleInterval" data-bs-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="visually-hidden" >Previous</span>
  </button>
  <button style="background-color: #ffffff73;" class="carousel-control-next" type="button" data-bs-target="#carouselExampleInterval" data-bs-slide="next">
    ...
    <section class="m">
        ...
        <div class="p page">
            ...
            <div class="card1">
                    ...
                    <span>Admin</span>
                    <a href="alogin.php" target="_blank">
                    <button> view
                    </button></a>
                </div>
            </div>
 ...
 <div class="h">
      <div><i class="fa-solid fa-chair"></i><span style="color:red;font-weight:500;">Book Your Table Now </span> <br><br>Have a Look at Available Tables Today</div>
      </div>
      <div class="tbl">
