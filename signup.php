...
<div class="form-container">
    ...
    <div class="input-group">
        ...
        <div class="input-group">
			...
			<input type="text" name="mo" id="username" placeholder="">
		</div>
        <div class="input-group">
			<label for="username">Address</label>
			<input type="text" name="add" id="username" placeholder="">
		</div>
		<div class="input-group">
...
if(isset($_POST['signup']))
{
    ...
    $user=$_POST['username'];
    $pass=$_POST['password'];
    $sql1 = "INSERT INTO `user`(`name`, `username`, `password`, `mobile`, `address`) VALUES ('$name','$user','$pass','$mobile','$add') ";
